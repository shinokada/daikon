...
$config['asset'][] = array('file'=>'http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.5/jquery-ui.min.js', 'name' => 'jquery_ui', 'needs'=>'jquery');
...
// Back-end Project
$config['asset'][] = array('file'=>'jquery.alerts.js', 'needs'=>'jquery');
$config['asset'][] = array('file'=>'jquery_alerts.css', 'needs'=>'jquery');
...
$config['asset_group']['ADMIN'] = 'jquery_ui|jquery.dataTables.min|demo_table|bep_admin_layout|bep_admin_style|FlashStatus|forms|buttons|bep_navigation|treeview|bep_icons|bep_select_all|master|jquery.datepick|jquery.datepick.pack|jquery.alerts|jquery_alerts|coda|site';
