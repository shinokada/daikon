...
if (count($projects)){
            ...
            echo "<thead>\n<tr valign='top'>\n";
            echo "<th class=\"left\" >Project Name</th>\n<th>Show Log</th>\n<th>Enter Log</th>\n<th>Specs</th>\n<th>Files</th>\n<th>Total hour</th><th class=\"middle\">Active</th>\n<th>Delete Project</th>\n<th>Edit Project</th>\n";
            echo "</tr>\n</thead>\n<tbody>\n";

            foreach ($projects as $key => $list){
                echo "<tr valign='top'>\n";
                echo "<td class=\"left\" width=\"20%\">".$list['project_name']."</td>\n";
                echo "<td width=\"10%\"><a href=\"../showlog/".$list['customer_id']."/".$list['id']."\" >".$this->bep_assets->icon('document16','Show Log')."</a></td>\n";
                echo "<td width=\"10%\"><a href=\"../enterlog/".$list['customer_id']."/".$list['id']."\" >".$this->bep_assets->icon('glyphadd16','Enter Log')."</a></td>\n";
                echo "<td width=\"10%\"><a href=\"../adminspec/showspec/".$list['customer_id']."/".$list['id']."\" >".$this->bep_assets->icon('arrow_right_16','Show Project Spec')."</a></td>\n";
